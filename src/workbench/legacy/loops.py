"""
Agent execution loop (legacy — moved from workbench.agents.loops).
...
from workbench.legacy.policies import Action, ActionType
...
class AgentLoop:
    ...
    .. deprecated::
        Use LangGraph graphs from ``workbench.graphs`` instead.
